...
$namecate = $db->executeResult($sql2, true);
?>
...
<div class="container" style="margin-top: 20px; margin-bottom: 20px;">
	<h2 style="text-align: center;margin:50px 0;"><?= $namecate['name'] ?></h2>
	<div class="row">
		<?php
		foreach ($lastestItems as $item) {
			echo '<div class="col-md-3 col-6 product-item">
					...
					<a href="detail.php?id=' . $item['id'] . '"><p style="font-weight: bold;max-height:40px;">' . $item['name'] . '</p></a>
