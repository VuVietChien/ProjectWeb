...
// $categories = $db->connection->query($sql);
// $sql1 = "SELECT * FROM sliders";
// $sliders = $db->connection->query($sql1);
$categories = $db->executeResult("SELECT * FROM categories");
$sliders = $db->executeResult("SELECT * FROM sliders");
