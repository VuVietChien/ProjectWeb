...
<body>
    ...
    <div class="Content">
        ...
        <div class="Products">
            <div class="products-sp">
                <div class="products_anh">
                    <img class="to" src="./image/Ao_thun_chay_bo_3_Soc_Own_The_Run_DJen_H36450_21_model.jpg"  id="img-main"/>
                    <div class="products_anh-nho">
                        <img class="nho" src="./image/ao2.jpg" id="nho">
                        <img class="nho" src="./image/Ao_thun_chay_bo_3_Soc_Own_The_Run_DJen_H36450_21_model.jpg" id="be" >
                    </div>
                </div>
                ...
                <div class="products_tt">
                    ...
                    <h2>ÁO THUN CHẠY BỘ 3 SỌC OWN THE RUN</h2>
                    <h4>White / Yellow</h4>
                    <h4 class="chu">750.000₫</h4>
                    <div class="muah">
                        <h4>Số Lượng</h4>
                        <input type="text">
                        <a href="#"><i class="ti-shopping-cart"></i>Thêm vào giỏ hàng</a>
                    </div>
                    <h5>Tình trạng: Còn Hàng</h5>
                    <h5>Band: E-SHOPPER</h5>
            ...
            <div id="mota">
                <div class="mota-tt">
                <h2 class="mota-tt1">ÁO THUN CHẠY BỘ 3 SỌC OWN THE RUN</h2>
                <h2 class="mota-tt2">CHIẾC ÁO THUN CHẠY BỘ PHẢN QUANG LÀM TỪ CHẤT LIỆU TÁI CHẾ.</h2>
                <p>Đường chạy của bạn. Thời gian của bạn. Hãy tận dụng cả hai với chiếc áo thun chạy bộ adidas này. Áo có kiểu dáng hỗ trợ vận động với đường may lộn ngoài và vạt bầu. Chất vải AEROREADY thoát ẩm cho cảm giác mềm mại trên da. 
                Áo còn thân thiện với hành tinh xanh, mang đến cho bạn cảm giác dễ chịu về nhiều mặt.</p>
                <p>Sản phẩm này may bằng vải công nghệ Primegreen, thuộc dòng chất liệu tái chế hiệu năng cao.</p>
            </div>
            <img src="./image/Ao_thun_chay_bo_3_.jpg" alt="">
        </div>
        ...
        <div id="thongso">
            ...
            <div class="thongso-1">
                <ul>
                    <li><i class="ti-control-record"></i> Dáng regular fit</li>
                    <li><i class="ti-control-record"></i> Cổ tròn</li>
                    <li><i class="ti-control-record"></i> Vải jacquard làm từ 100% polyester tái chế</li>
                    <li><i class="ti-control-record"></i> Mềm mại và thoáng khí</li>
                </ul>
            </div>
            <div class="thongso-2">
                <ul>
                    <li><i class="ti-control-record"></i> Phản quang 360 độ</li>
                    <li><i class="ti-control-record"></i> Primegreen</li>
                    <li><i class="ti-control-record"></i> Màu sản phẩm: Black / Black / Acid Yellow</li>
                    <li><i class="ti-control-record"></i> Mã sản phẩm: GM6002</li>
                </ul>
            </div>
        </div>
    </div>
