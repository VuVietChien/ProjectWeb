				...
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Đồ gia đình</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="#">Đồ tập </a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
						...
						<div class="brands_products">
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href=""> <span class="pull-right">(27)</span>Jordan</a></li>
									<li><a href=""> <span class="pull-right">(32)</span>Puma</a></li>
									<li><a href=""> <span class="pull-right">(5)</span>Under Armour</a></li>
									<li><a href=""> <span class="pull-right">(9)</span>Kappa</a></li>
									<li><a href=""> <span class="pull-right">(4)</span>Fila</a></li>
								</ul>
							</div>
						</div>
						<!--/brands_products-->
									...
									<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2><? echo number_format($product['price']) . ' VNĐ' ?></h2>
												<p><?= $product['name'] ?></p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
